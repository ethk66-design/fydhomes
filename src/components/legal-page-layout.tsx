        ...
        <main className="min-h-screen bg-white pt-[120px] pb-16 sm:pb-24">
            <div className="container mx-auto px-4 sm:px-6 max-w-[1000px]">
                ...
                <div className="mb-10 sm:mb-14 text-center">
                    ...
                    <div className="w-16 h-1 bg-[#E3572D] mx-auto mt-6 rounded-full" />
                </div>

                {/* Content */}
                <div className="prose prose-lg max-w-none text-[#555555] prose-headings:text-[#222222] prose-headings:font-bold prose-a:text-[#E3572D] prose-a:no-underline hover:prose-a:underline prose-li:marker:text-[#E3572D]">
                    {children}
                </div>
