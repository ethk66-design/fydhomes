  ...
  return (
    <section className="bg-[#0A192F] py-[80px]">
      <div className="container px-6 max-w-[1140px] mx-auto">
        <div className="mb-8">
          <h2 className="font-display text-[32px] font-bold leading-[1.3] text-white mb-6">
            FAQ
          </h2>
        </div>
          ...
          <div className="space-y-0">
            {faqData.map((item, index) => (
              ...
              >
                ...
                >
                  <span className="font-sans text-[16px] font-semibold text-white leading-tight pr-4">
                    {item.question}
                  </span>
                  <div className="flex-shrink-0">
                    {openIndex === index ? (
                      ...
                      <Plus className="w-4 h-4 text-[#E3572D]" strokeWidth={3} />
                    )}
                  </div>
                </button>
                ...
                >
                  <p className="font-sans text-[15px] leading-relaxed text-gray-300 mb-0">
                    {item.answer}
                  </p>
                </div>
              </div>
