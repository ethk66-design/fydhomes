      ...
      <div className="container mx-auto px-4 sm:px-5 lg:max-w-[1480px]">
        <div className="relative group">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-2 sm:gap-[10px] items-stretch">
            <div className="md:col-span-2 overflow-hidden rounded-[4px] relative h-[250px] sm:h-[350px] md:h-[450px] lg:h-[564px] cursor-pointer group/main" onClick={() => openModal(0)}>
              <ImageWithFallback
                src={displayImages[0]}
            ...
            <div className="flex flex-row md:flex-col gap-2 sm:gap-[10px] h-[120px] sm:h-[150px] md:h-[450px] lg:h-[564px]">
              <div className="flex-1 overflow-hidden rounded-[4px] relative cursor-pointer group/sub1" onClick={() => openModal(1)}>
                <ImageWithFallback
              ...
              <div className="flex-1 overflow-hidden rounded-[4px] relative cursor-pointer group/sub2" onClick={() => openModal(2)}>
                <ImageWithFallback
