...
// Assuming public read access, we only need the URL
const sourceUrlBase = 'https://vexsmxrfxbatpyelugch.supabase.co/storage/v1/object/public/';

// --- Env Setup ---
// We need target (US) env for Supabase Storage Upload
...
function getPathFromUrl(url) {
    try {
        ...
        // Example: /storage/v1/object/public/property-images/migrated/123/img.jpg
...
async function processImage(imageRecord) {
    ...
    console.log(`\nProcessing Image ID: ${imageRecord.id}`);
...
async function migratePropertyImages() {
    console.log("🚀 Starting Property Image Migration (India -> US)...");
    ...
    try {
        ...
        console.log(`Found ${images.length} property images requiring migration.`);
        ...
        console.log("\n🏁 Property Image Migration Complete.");
