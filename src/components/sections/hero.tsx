            ...
            <div className="w-full max-w-[1070px] bg-white p-4 sm:p-6 md:p-8 rounded-[4px] shadow-[0_8px_24px_rgba(0,0,0,0.08)] sm:shadow-[0_15px_40px_rgba(0,0,0,0.1)] border border-[#eeeeee] flex flex-col gap-4 animate-in fade-in slide-in-from-bottom-10 duration-700 delay-200">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-4">
                  <div className="flex flex-col gap-2">
                    <label className="text-[10px] sm:text-[11px] font-bold text-[#333333] uppercase tracking-[1px]">SEARCH</label>
                    <div className="relative">
                      <input 
                        ...
                        className="w-full h-[48px] sm:h-[50px] px-4 text-[14px] sm:text-[15px] border border-[#dddddd] rounded-[4px] focus:outline-none focus:border-[#1db954] placeholder:text-[#999999] transition-all"
                      />
                    </div>
                  </div>

                  <div className="flex flex-col gap-2">
                    <label className="text-[10px] sm:text-[11px] font-bold text-[#333333] uppercase tracking-[1px]">LOOKING FOR</label>
                    <div className="relative">
                      <select 
                        value={type}
                        onChange={(e) => setType(e.target.value)}
                        className="w-full h-[48px] sm:h-[50px] px-4 text-[14px] sm:text-[15px] bg-white border border-[#dddddd] rounded-[4px] appearance-none cursor-pointer focus:outline-none focus:border-[#1db954] text-[#555555] transition-all"
                      >
                  ...
                  <div className="flex flex-col gap-2">
                    <label className="text-[10px] sm:text-[11px] font-bold text-[#333333] uppercase tracking-[1px]">SEARCH BY AREA</label>
                    <div className="relative">
                      <select 
                        value={area}
                  ...
                  <div className="flex flex-col gap-2">
                    <label className="text-[10px] sm:text-[11px] font-bold text-[#333333] uppercase tracking-[1px] opacity-0 hidden sm:block">&nbsp;</label>
                    <button 
                      onClick={handleSearch}
                      className="w-full h-[48px] sm:h-[50px] bg-[#1db954] hover:bg-[#1aa34a] text-white flex items-center justify-center rounded-[4px] transition-colors duration-200"
                    >
