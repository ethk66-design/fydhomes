        ...
        <div className="relative w-full min-h-[350px] sm:min-h-[400px] md:min-h-[450px] lg:min-h-[550px] rounded-[10px] overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10 h-full flex items-center px-4 sm:px-6 md:px-16 py-8 sm:py-10 md:py-12 lg:py-20">
            <motion.div
              ...
              className="bg-[#040C1A]/95 border border-white/10 p-5 sm:p-6 md:p-8 lg:p-14 w-full sm:max-w-[450px] md:max-w-[500px] lg:max-w-[550px] rounded-[10px] shadow-2xl backdrop-blur-md"
            >
              <h2 className="text-[24px] sm:text-[28px] md:text-[32px] lg:text-[42px] font-bold leading-[1.1] text-white mb-4 sm:mb-6">
                Looking To Buy Or Sell?<br />
                Get Expert Guidance Today!
              </h2>

              <p className="text-[14px] sm:text-[16px] md:text-[18px] leading-[1.5] text-gray-300 mb-6 sm:mb-8 md:mb-10 max-w-[450px]">
                Contact us now for a free consultation and let our team of experts guide you through the process.
              </p>

              <a
                href="/contact"
                className="inline-block bg-[#E3572D] hover:bg-[#ff693e] text-white text-[13px] sm:text-[14px] md:text-[15px] font-bold uppercase tracking-[1px] px-6 sm:px-8 md:px-10 py-3 sm:py-3.5 md:py-4 rounded-[6px] transition-all duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
              >
                CONTACT US
              </a>
            </motion.div>
