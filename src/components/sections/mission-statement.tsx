...
const MissionStatement = () => {
  return (
    <section className="bg-[#040C1A] py-[80px] md:py-[100px]">
      <div className="container mx-auto px-6 max-w-[1140px]">
        {/* Section Heading */}
        <div className="mb-12 md:mb-16">
          <h2 className="font-display text-[32px] md:text-[36px] font-bold leading-[1.3] text-white">
            Finding You Homes, <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#E3572D] to-[#ff8c6b]">Building Dreams</span> — <br className="hidden md:block" /> Right Here in Kochi
          </h2>
        </div>
