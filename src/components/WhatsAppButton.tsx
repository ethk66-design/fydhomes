...
export function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute right-full mr-3 bg-white text-[#205c6d] px-4 py-2 rounded-lg text-sm font-bold shadow-xl opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap border border-gray-100 pointer-events-none">
